...
neg_data=1./(1+tf.exp(-tf.nn.conv2d_transpose(pos_conv1_prob,W_conv1,[gd.BATCH_SIZE,input_size,input_size,chanl_input],strides=[1,1,1,1],padding='VALID')-a_conv1))
